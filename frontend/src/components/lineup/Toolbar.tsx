    ...
    <div className="flex flex-wrap items-center justify-between gap-2">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`px-3 py-2 rounded-lg text-xs font-semibold border transition-all flex items-center gap-1.5 cursor-pointer min-h-[36px] ${
            showZones
        ...
        >
          ...
          <span className="hidden sm:inline">{showZones ? t.hideZones : t.showZones}</span>
        </button>
